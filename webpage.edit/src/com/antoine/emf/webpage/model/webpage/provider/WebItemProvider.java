/**
 */
package com.antoine.emf.webpage.model.webpage.provider;


import com.antoine.emf.webpage.model.webpage.Web;
import com.antoine.emf.webpage.model.webpage.WebpageFactory;
...
/**
 * This is the item provider adapter for a {@link com.antoine.emf.webpage.model.webpage.Web} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addKeywordPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Web_keyword_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Web_keyword_feature", "_UI_Web_type"),
				 WebpagePackage.Literals.WEB__KEYWORD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPagesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Web_pages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Web_pages_feature", "_UI_Web_type"),
